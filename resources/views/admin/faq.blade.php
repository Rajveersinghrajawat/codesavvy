        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form class="p-4" action="{{ url('codesavvy-admin/add_faq') }}" method="POST">
                        @csrf
                        ...
                        <div class="faq-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="faq-answer" name="answer" class="form-control" rows="3" placeholder="Enter answer"></textarea>
                            </div>
                        </div>
